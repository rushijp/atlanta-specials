export const WEBSITE_THEMES = {
  ...
  'maroon-gold': {
    key: 'maroon-gold',
    name: 'Maroon & Gold',
    description: 'Traditional Hindu wedding colors with ornate gold detailing.',
    primary: '#6b1d2a',
    accent: '#d4a848',
    background: '#fdf5e6',
    surface: '#fff9ef',
    ...
    fontUrl: 'https://fonts.googleapis.com/css2?family=Cinzel+Decorative:wght@400;700&family=Cormorant+Garamond:ital,wght@0,400;0,600;1,500&display=swap',
    heroOverlay: 'linear-gradient(135deg, rgba(74, 14, 26, 0.78), rgba(107, 29, 42, 0.50))',
    ornaments: true,
  },
  'saffron-celebration': {
    key: 'saffron-celebration',
    name: 'Saffron Celebration',
    description: 'Vibrant saffron and cream with flowing calligraphic script.',
    primary: '#c2410c',
    accent: '#ff9933',
    background: '#fff7ed',
    surface: '#fffbf5',
    ...
    fontUrl: 'https://fonts.googleapis.com/css2?family=Great+Vibes&family=Poppins:wght@300;400;500;600&display=swap',
    heroOverlay: 'linear-gradient(135deg, rgba(124, 45, 18, 0.75), rgba(234, 88, 12, 0.40))',
    ornaments: true,
  },
  'midnight-peacock': {
    key: 'midnight-peacock',
    name: 'Midnight Peacock',
    description: 'Deep jewel tones inspired by peacock feathers and starlit celebrations.',
    primary: '#134e4a',
    accent: '#5eead4',
    background: '#f0fdfa',
    surface: '#ffffff',
    ...
    fontUrl: 'https://fonts.googleapis.com/css2?family=Cinzel:wght@400;600;700&family=Cormorant+Garamond:wght@400;500;600&display=swap',
    heroOverlay: 'linear-gradient(135deg, rgba(4, 47, 46, 0.82), rgba(15, 118, 110, 0.45))',
    ornaments: true,
  },
  'ivory-blush': {
    key: 'ivory-blush',
    name: 'Ivory & Blush',
    description: 'Soft dusty rose and warm ivory for a modern Indian aesthetic.',
    primary: '#9f1239',
    accent: '#fda4af',
    background: '#fef2f2',
    surface: '#fffafa',
    ...
    fontUrl: 'https://fonts.googleapis.com/css2?family=Tangerine:wght@400;700&family=Lora:wght@400;500;600&display=swap',
    heroOverlay: 'linear-gradient(135deg, rgba(76, 5, 25, 0.70), rgba(159, 18, 57, 0.40))',
    ornaments: true,
  },
};
